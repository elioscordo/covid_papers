...
logger = logging.getLogger('papers.models')
...
class Paper(models.Model):
    ...
    microsoft_pid = models.CharField(
        'Microsoft Academic Paper ID', max_length=500, blank=True, null=True
    )
    # rename of the column WHO #Covidence
    coevidence = models.CharField(
        'WHO #Covidence', max_length=500, blank=True, null=True
    )
    ...
    # publish date is the datefied version of publish time.
    ...
    def save(self, *args, **kwargs):
        ...
        if self.publish_time:
            if self.publish_time.isdigit():
                # The first day of the year is set by convention
